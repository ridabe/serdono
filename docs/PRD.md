...
1. Escolhe o próprio nicho num catálogo de 49 opções (5 → 31 em 04/08/2026; + 18 ramos de baixa estrutura em 31/08/2026, ver nota de dado abaixo) ou descreve em texto livre se não encontrar.
...
**+ 18 ramos de baixa estrutura (31/08/2026 — SDD-134):** negócios que dá pra tocar de casa e com pouco investimento (bolo de pote, cuidador de pets, cuidador de idosos, designer freelancer, manicure em casa, revenda de roupas...), pra a seção pública "Quanto custa abrir" (§ campanha SDD-133) atrair quem empreende na informalidade a se profissionalizar. Entram **só** no catálogo de seleção ("já tenho negócio") e nas páginas públicas — **fora do Fit Score do diagnóstico** (`ativo_no_mvp = false`), decisão do dono do produto de não mexer no diagnóstico nesta rodada.
